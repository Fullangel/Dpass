                                                    ...
                                                    <div class="id-card">
                                                        <div class="id-card-photo">
                                                            @if($visitingDetails->getFirstMediaUrl('visitor'))
                                                                ...
                                                                <img src="{{ $visitingDetails['photo'] }}" alt="">
                                                                @else
                                                        ...
                                                        <h3>{{__('Fecha: ')}}{{$visitingDetails->created_at}}</h3>
                                                        ...
                                                        <h3>{{__('')}} {{$visitingDetails->employee->phone}}</h3>
                                                        <hr>
                                                        <p><strong>{{ setting('site_name') }} </strong></p>
                                                        <p><strong>{{ setting('site_address') }} </strong></p>
                                                        <p>{{__('')}} {{ setting('site_phone') }}  {{__('')}} {{ setting('site_email') }} </p>
                                                    </div>
                                                </div>
                                            </div>
