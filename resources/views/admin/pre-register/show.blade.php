			    	...
			    	<div class="card">
			    		<div class="card-body">
							...
							@if (setting('whatsapp_message'))
								...
								<div class="float-right">
									<a id="waButton" href="https://wa.me/{{ $preregister->visitor->phone }}?text={{ urlencode(strip_tags(setting('whatsapp_accept_message'))) }}%20{{ urlencode(route('qrcode', $preregister->visitor->phone)) }}" target="_blank" class="btn btn-success mr-1">Enviar por WhatsApp</a>
								</div>
							@endif
			    		</div>
			    	</div>
