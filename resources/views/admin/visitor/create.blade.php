                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select id="headquarters_id" name="headquarters_id" class="form-control @error('headquarters_id') is-invalid @enderror" required>
                                            <option value="">{{ __('headquarters.select_headquarters') }}</option>
                                            @foreach($headquarters as $headquarter)
                                                <option value="{{ $headquarter->id }}" data-region="{{ $headquarter->region_id }}" {{ (old('headquarters_id') == $headquarter->id) ? 'selected' : '' }}>{{ $headquarter->name }}</option>
                                            @endforeach
                                        </select>
